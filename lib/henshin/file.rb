...
module Henshin
  ...
  class File
    ...
    # definition with the same name. When #data is called it will add an item to
    # the data hash with the key as the method's name and the value as the
    # return value from the method. The method will be passed no arguments but
    # will obviously have access to all of the instance variables set (@site
    ...
    # Set values for all instances of the class. Basically stores the key-values
    # given and then calls #set with them when a new instance is created.
    #
    # @param key [Symbol]
    # @param value [Object]
    # @see #set
